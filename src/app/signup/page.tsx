      ...
      >
        <GlassCard className="p-8 sm:p-10 flex flex-col gap-6 bg-white/40 border-white/50 shadow-2xl backdrop-blur-3xl">
          ...
          <div className="flex flex-col items-center mb-2">
            <div className="w-14 h-14 rounded-[1.2rem] bg-gradient-to-tr from-indigo-600 to-purple-400 p-[1px] mb-6 shadow-xl shadow-purple-500/20">
            ...
            <p className="text-slate-600 font-medium text-sm mt-2 text-center">
              Start building your spatial digital twin today.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <GlassButton 
              type="submit" 
              disabled={loading}
              className="w-full mt-2 py-4 bg-purple-600 hover:bg-purple-700 text-white font-semibold shadow-[0_4px_20px_rgba(147,51,234,0.3)] disabled:opacity-70 flex justify-center items-center"
            >
          ...
          <p className="text-center text-sm text-slate-600 mt-2 font-medium">
            ...
            <Link href="/login" className="text-purple-600 hover:text-purple-700 font-semibold underline-offset-4 hover:underline">
              Sign in
            </Link>
          </p>
